...
import { Button, Label, Entry, MultiLineEntry, PasswordEntry, Separator, Hyperlink, VBox, HBox, Checkbox, Select, Slider, ProgressBar, Scroll, Grid, RadioGroup, Split, Tabs, Toolbar, ToolbarAction, Table, List, Calendar, DateSelectedEvent, Center, Max, Card, Accordion, Form, Tree, RichText, Image, Border, GridWrap } from './widgets';
...
export class App {
  ...
  calendar(initialDate?: Date, onDateSelected?: (event: DateSelectedEvent) => void): Calendar {
    return new Calendar(this.ctx, initialDate, onDateSelected);
  }
